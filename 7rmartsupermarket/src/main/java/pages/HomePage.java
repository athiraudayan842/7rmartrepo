...
public class HomePage {
	...
	@FindBy(xpath="//a[contains(@href,'uniqassosiates.com/admin/list-admin')and @class='small-box-footer']")WebElement moreinfoAdmin;
	@FindBy(xpath="//a[contains(@href,'uniqassosiates.com/admin/list-contact')]")WebElement moreinfoManageContact;
	@FindBy(xpath="//a[contains(@href,'uniqassosiates.com/admin/list-news')]")WebElement moreinfoManageNews;
	@FindBy(xpath="//a[contains(@href,'uniqassosiates.com/admin/list-category')]")WebElement moreinfomanagecategory;
	@FindBy(xpath="//a[contains(@href,'uniqassosiates.com/admin/list-footertext')]")WebElement moreinfomanagefooter;	
